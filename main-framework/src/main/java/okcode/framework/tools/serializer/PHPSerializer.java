 ...
 * @File: PHPSerializer.java
 * @package okcode.framework.tools
 * @Description:
 * @author micwing
 ...
 */
package okcode.framework.tools.serializer;
...
public class PHPSerializer {
    ...
    private static int writeObject(ByteArrayOutputStream stream, Object obj, HashMap ht, int hv, String charset) {
        ...
        if (obj instanceof java.io.Serializable) {
            ...
            if (obj instanceof okcode.framework.tools.serializer.Serializable) {
                byte[] cs = ((okcode.framework.tools.serializer.Serializable) obj).serialize();
    ...
    private static UnSerializeResult readCustomObject(ByteArrayInputStream stream, HashMap ht, int hv, String charset) {
        ...
        if (o == null) {
            stream.skip(n);
        } else if (o instanceof okcode.framework.tools.serializer.Serializable) {
            byte[] b = new byte[n];
 
            stream.read(b, 0, n);
            ((okcode.framework.tools.serializer.Serializable) o).unserialize(b);
        } else {
            stream.skip(n);
        }
        stream.skip(1);
