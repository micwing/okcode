...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav btn-group">
        <li class="btn btn-inverse" ><a title="" href="${ctx}/console/personalInfo"><i class="icon icon-user"></i> <span class="text">个人资料</span></a></li>
        ...
        <li class="btn btn-inverse"><a title="" href="${ctx}/console/signin/doSignout"><i class="icon icon-share"></i> <span class="text">退出</span></a></li>
    </ul>
</div>