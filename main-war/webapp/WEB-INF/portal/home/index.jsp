...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
				<div class="bannercontainer" >
                    <div class="banner" >
                        <ul>
                            <li class="slide1 slide" data-transition="boxfade" data-slotamount="5"  data-masterspeed="300">
                                <img alt="" src="${ctx}/asset/portal/img/slider01.png" />
                                <div class="caption sft carousel-caption" data-x="110" data-y="110" data-speed="1000" data-start="1000" data-easing="easeInBack" style="background: none;">
                                    <p class="middle">美观、整洁、快速响应 & 自适应</p>
                                </div>
                                ...
                                <div class="caption sfl carousel-caption" data-x="98" data-y="191" data-speed="1000" data-start="1000" data-easing="easeOutBack" style="background: none;">
                                    <p class="big">基于 HTML5 —— 一刻企业网站管理系统</p>
                                </div>
                                <div class="caption sfb carousel-caption" data-x="111" data-y="247" data-speed="1000" data-start="1000" data-easing="easeInBack" style="background: none; width: 436px;">
                                    <p class="small">带您跨入21世纪的互联网世界<br>漂亮、整洁、快速响应、自适应，为您有效、自如的控制企业门户网站</p>
                                </div>
                            </li>
                            <li class="slide2 slide" data-transition="slideleft" data-slotamount="10"  data-masterspeed="300">
                                <img alt="" src="${ctx}/asset/portal/img/slider02.png" />
                                <div class="caption sft carousel-caption" data-x="472" data-y="69" data-speed="1000" data-start="1000" data-easing="easeInBack" style="background: none;">
                                    <p class="middle">您的企业网站已经加入到无线互联网浪潮里了吗?</p>
                                </div>
                                ...
                                <div class="caption sfb carousel-caption" data-x="474" data-y="262" data-speed="1000" data-start="1000" data-easing="easeInBack" style="background: none; width: 436px;">
                                    <p class="small">您的企业已经准备好了吗? <br>适应手机设备访问的解决方案就在 一刻企业网站管理系统 </p>
                                </div>
                            </li>
                            <li class="slide3 slide" data-transition="slidedown" data-slotamount="1" data-masterspeed="300">
                                <img alt="" src="${ctx}/asset/portal/img/slider03.png" />
                                <div class="caption sft carousel-caption" data-x="43" data-y="184" data-speed="1000" data-start="1000" data-easing="easeInBack" style="background: none; padding-left: 0;">
                                    <p class="middle">快速、简单的创建Web页面</p>
                                </div>
                                ...
                                <div class="caption sfb carousel-caption" data-x="0" data-y="281" data-speed="1000" data-start="1000" data-easing="easeInBack" style="background: none; padding-left: 0; width: 100%;">
                                    <p class="small">您也可以花费少许费用，为您的企业量身订制精美模板。您一定会觉得物超所值！</p>
                                </div>
                            </li>
                            <li class="slide5 slide" data-transition="slotfade-horizontal"  data-masterspeed="300" data-slotamount="20">
                                <img alt="" src="${ctx}/asset/portal/img/slider04.png" />
                                ...
                                <div class="caption sfb carousel-caption" data-x="480" data-y="268" data-speed="1000" data-start="1000" data-easing="easeInBack" style="background: none; padding-left: 0;">
                                    <p class="small">简单、快捷、有效、自适应、便于维护，当您亲自使用过之后一定会有此感受</p>
                                </div>
                            </li>
                        ...
                        <div class="row show-grid hero-list">
                            <div class="span3">
                                <div class="image-wrapper">
                                    <div class="img"><img alt="" src="${ctx}/asset/portal/img/ruler.png" /></div>
                                </div>
                            ...
                            <div class="span3">
                                <div class="image-wrapper">
                                    <div class="img"><img alt="" src="${ctx}/asset/portal/img/equaliser.png" /></div>
                                </div>
								<div class="image-text">
	                                <h2>Flexible Layout</h2>
	                                <p>Flexible page layout templates to help you quickly organize your website's content.
	                                    <a href="#">Learn more&nbsp;&raquo;</a>
	                                </p>
								</div>
								<div class="clear"></div>
                            ...
                            <div class="span3">
                                <div class="image-wrapper">
                                    <div class="img"><img alt="" src="${ctx}/asset/portal/img/direction.png" /></div>
                                </div>
								<div class="image-text">
	                                <h2>Quick Shortcuts</h2>
	                                <p>Dozens of unique shortcuts to add your own cool and custom flare.
	                                    <a href="#">Learn more&nbsp;&raquo;</a>
	                                </p>
								</div>
								<div class="clear"></div>
                            ...
                            <div class="span3">
                                <div class="image-wrapper">
                                    <div class="img"><img alt="" src="${ctx}/asset/portal/img/both_arrows.png" /></div>
                                </div>
								<div class="image-text">
	                                <h2>Responsive</h2>
									<p>Ultra-responsive design so your pages work beautifully on practically any device.
	                                    <a href="#">Learn more&nbsp;&raquo;</a>
	                                </p>
								</div>
								<div class="clear"></div>
                ...
                <c:if test="${!empty dto.articleCatalog && !empty dto.articles}">
                <div class="main-block testimonials">
                    <div class="title-wrapper">
                        <h2>${dto.articleCatalog.title}</h2>
                    </div>
                    <div class="clear-both"></div>
                    <div class="row show-grid">
                        <div class="span12">
                        <c:forEach items="${dto.articles}" var="article">
                            <div class="testimonials-block">
                                <div class="quote"></div>
                                <p class="first-row">${article.title}</p>
                                <p>${article.subTitle}</p>
                                <p class="autor"><a href="${ctx}/portal/article/detail/${article.id}" target="_blank">阅读全文&nbsp;&raquo;</a></p>
                            </div>
                        </c:forEach>
                        </div>
                    </div>
                ...
                <c:if test="${!empty dto.productCatalog && !empty dto.products}">
                <div class="main-block block-posts">
                    <div class="title-wrapper">
                        <h2>${dto.productCatalog.title}</h2>
                    </div>
                    <div class="row show-grid clear-both">
                        <div class="span12">
                            <div class="row show-grid">
                                ...
                                <div class="span3">
	                                <a class="block-post-img" href="${ctx}/portal/article/detail/${product.id}" target="_blank">
	                                    <img alt="" src="${product.attr.imageUrl1thumb}" class="img-rounded" />
	                                </a>
                                    <a class="block-post-title" href="${ctx}/portal/article/detail/${product.id}" target="_blank">${product.title}</a>
                                    <p class="block-post-content">${product.subTitle}</p>
                                    <a class="block-post-more" href="${ctx}/portal/article/detail/${product.id}" target="_blank">阅读全文&nbsp;&raquo;</a>
                                </div>
                            	</c:forEach>
                            </div>
                        </div>
                ...
                <c:if test="${!empty dto.imageCatalog && !empty dto.images}">
                <div class="portfolio-grid-1 main-block">
                    <div class="title-wrapper">
                        <h2>${dto.imageCatalog.title}</h2>
                    </div>
                    <div class="clear-both"></div>
                    <div id="home_responsive" class="row show-grid">
                    	<c:forEach items="${dto.images}" var="image">
                        <div class="span3 small hp-wrapper">
                            <a class="top-link" href="${ctx}/portal/article/detail/${image.id}" target="_blank"><img alt="" src="${image.attr.imageUrl1thumb}" /></a>
                            <div class="bottom-block">
                                <a href="${ctx}/portal/article/detail/${image.id}" target="_blank">${image.title}</a>
                                <p>${image.subTitle}</p>
                            </div>
                        </div>
                        </c:forEach>
                ...
                <c:if test="${!empty dto.jobCatalog && !empty dto.jobs}">
                <div class="main-block testimonials">
                    <div class="title-wrapper">
                        <h2>${dto.jobCatalog.title}</h2>
                    </div>
                    <div class="clear-both"></div>
                    <div class="row show-grid">
                       	<c:forEach items="${dto.jobs}" var="job">
                        <div class="span12 grey-box" style="margin-bottom: 10px;">
                            <div class="hero-block3">
                                <div class="row show-grid">
                                    <div class="span9">
                                        <div class="hero-content-3">
                                            <h2>${job.title}</h2>
                                            <p>[ 工作地点: ${job.attr.place} ] [ 工资待遇: ${job.attr.deal} ] [ 招聘人数: ${job.attr.count} ] [ 有效时间: ${job.attr.enableDays} ]</p>
                                        </div>
                                    </div>
                                    <div class="span3">
                                        <div class="tour-btn">
                                            <a href="${ctx}/portal/article/detail/${job.id}" target="_blank" class="btn btn-warning">查看详细</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="span12">
                            <div id="clients" class="row show-grid">
                                <div class="span2 clear-both hp-wrapper">
                                    <img alt="" src="${ctx}/asset/portal/img/client1.jpg" />
                                </div>
                                <div class="span2 hp-wrapper">
                                    <img alt="" src="${ctx}/asset/portal/img/client2.jpg" />
                                </div>
                                <div class="span2 hp-wrapper">
                                    <img alt="" src="${ctx}/asset/portal/img/client3.jpg" />
                                </div>
                                <div class="span2 hp-wrapper">
                                    <img alt="" src="${ctx}/asset/portal/img/client4.jpg" />
                                </div>
                                <div class="span2 hp-wrapper">
                                    <img alt="" src="${ctx}/asset/portal/img/client5.jpg" />
                                </div>
                                <div class="span2 hp-wrapper">
                                    <img alt="" src="${ctx}/asset/portal/img/client6.jpg" />
                                </div>
                            </div>
                        </div>
                    </div>
	                ...
	                <div class="container">
	                    <div class="row show-grid">
	                        <div class="span12 twitter-wrapper">
	                            ...
	                            <a class="follow_img" href="#"><img alt="" src="${ctx}/asset/portal/img/follow.png" /></a>
	                        </div>
	                    </div>
	                </div>
	            </div> --%>